...
public class MainView extends VerticalLayout {
     ...
     *            bean.
     */
    public MainView(@Autowired UserService service) {
        ...
        comboBox.setItems("Todos los usuarios", "Por Nombre", "Por correo");
        ...
        grid.addColumn(User::isAdmin).setHeader("Admin");
        grid.addColumn(User::getRoles).setHeader("Roles").setAutoWidth(true);


        TextField datos = new TextField("Nombre/Correo");
        ...
        e -> {
            ...
            try {
                ...
                if(tipoPeticion.equals("Por Nombre"))
                {
                    ...
                    results.add(service.leeUserporNombre(dato));
                }
                else if(tipoPeticion.equals("Por Correo"))
                {
                    results.add(service.leeUserporCorreo(dato));
                }
                else if(tipoPeticion.equals("Todos los usuarios"))
                {
                    grid.setItems(service.leeUsers());
                    results.add(grid);
                }
            } catch (Exception ex) {
            }
